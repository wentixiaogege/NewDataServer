...
public class ClassDeepCopy {
	 ...
	 */
	public static <T extends MessageOrBuilder> boolean CopyBeanToProto(
			Object bean, T proto, String... exceptions) {
				...
				.forEach(beanGetMethod -> {
					...
					// if method included in exceptions, ignoring it.
						...
						Optional<Method> opMethod = Arrays
								...
								.filter(y -> y.getName().equals(setMsgName))
								.findFirst();
						Method setMethod;
	 ...
	 * @return true copy right false copy failure.
	 */
	public static <T extends MessageOrBuilder> boolean CopyProtoToBean(T proto,
			Object bean, String... exceptions) {
		Class<? extends Object> beanClass = bean.getClass();
		Class<? extends Object> protoClass = proto.getClass();
		MutableBoolean flag = new MutableBoolean(true);
		// new big
	...
	public static boolean CopyObjects(Object source, Object dest,
			String... exceptions) {
