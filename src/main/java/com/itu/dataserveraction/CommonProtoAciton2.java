...
public abstract class CommonProtoAciton2<T extends Message> extends CommonAciton<T, String> {
	Logger logger = Log4jUtil.getLogger(CommonProtoAciton2.class);

	CommonProtoLogic2<T> cmpLogic;

	public CommonProtoAciton2() {
