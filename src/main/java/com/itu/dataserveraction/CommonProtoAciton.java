...
public abstract class CommonProtoAciton<T extends Message, V extends Message> extends CommonAciton<T, V> {
	Logger logger = Log4jUtil.getLogger(CommonProtoAciton.class);

	CommonProtoLogic<T, V> cmpLogic;

	public CommonProtoAciton() {
